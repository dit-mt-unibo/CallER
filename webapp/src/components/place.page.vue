    ...
    <div id="place" class="container">
        ...
        <div class="row rounded-top place-content pt-3">                       
            ...
            <div align="center" class="col-12 mt-3 mb-3" v-if="item.audio">
                <iframe v-if="!isBlocked" class="vocaroo" width="600" height="70" :src="item.audio" frameborder="0" allow="autoplay"></iframe>                
            </div>
        ...
        <div class="row box-related mb-3" v-if="item.category_id != 1">
            <ul class="list-group">
                ...
                <li class="list-group-item" v-for="rItem in relatedItems" v-bind:key="rItem" @click="goTo(rItem.id , 'place')">   
                    <div class="box-related-img">
                        <img id="img-top" class="card-img-mini" :src="this.apiUrl + '/images/contenuti/' + rItem.imageUID"/>
                    </div>                    
...
export default {
    ...
    methods : {
        ...
        async getRelatedPlaces() {
            ...
            const response = await axios.get(this.apiUrl + "/place-related/" + id + "/" + cat_id );
        ...
        async bodyClick(e) {            
            ...
            if (e.target.className === 'glossary') {
                ...
                const response =  await axios.get(this.apiUrl + "/glossary?name=" + e.target.dataset.id);
