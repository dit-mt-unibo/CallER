<template>
    <div class="container-fluid thunt-container">
        ...
        <div class="row">            
            ...
            <div align="center" class="col-12 mt-3" style="font-size: 3.7rem; color:#e4252a;">
                OOOPS
            </div>
        </div>
        <div class="row">
            <div class="col-12 mt-4">
                <p style="font-size: 1.3rem;">
                    Un errore imprevisto non ti sta permettendo di continuare con la caccia, premi il pulsante Home per provare a riprendere il gioco!
                </p>
            </div>
        </div> 
        <div class="row">
            <div class="col-12" align="center">
                <button class="thunt-button thunt-button-error" @click="this.$router.push('/caccia-al-tesoro')">Home</button>
            </div>
        </div>        
    </div>
