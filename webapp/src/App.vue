<!-- 
Template principale della WebApp all'interno del quale vengono visualizzate le pagine <router-view>
-->

<template>
  <div id="wrapper">
    <treasure-hunt-layout v-if="this.$route.meta.layout == 'hunt'" />
    <abgame-layout v-if="this.$route.meta.layout == 'abgame'" />
